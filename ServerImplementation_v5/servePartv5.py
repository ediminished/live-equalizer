...
from cleanFileToSend import removeOutliers
import socket
import sys
...
def threaded(c):
	try:
		...
		afridi = removeOutliers(out_data)
		# Write results onto a file to send to client
		print ("Writing results...")
		with open("file2send", "wb") as file2send:
			pickle.dump(afridi, file2send)
		file2send.close()


		#Cleaning results before sending to client
		#afridi = removeOutliers()
